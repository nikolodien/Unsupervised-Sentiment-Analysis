...
public class CharSequenceLexer implements Lexer, Serializable
{
	...
	public static final Pattern LEX_NEW_WORD_CLASSES	=
			Pattern.compile ("\\p{Alpha}+\\p{Punct}?\\p{Alpha}+|\\p{Digit}+|\\p{Punct}");
		...
		try {
			...
			for (String line = in.readLine(); line != null; line = in.readLine()) {
				CharSequenceLexer csl =
					new CharSequenceLexer (line, LEX_NEW_WORD_CLASSES );
				while (csl.hasNext())
