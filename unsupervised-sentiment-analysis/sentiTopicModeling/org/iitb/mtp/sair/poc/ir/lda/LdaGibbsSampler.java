package org.iitb.mtp.sair.poc.ir.lda;
...
public class LdaGibbsSampler {
     ...
     * @param data
     */
    public LdaGibbsSampler(String[][] documents, int V) {
    ...
    public void initialState(int K) {
        ...
        for (int m = 0; m < M; m++) {
            ...
            for (int n = 0; n < N; n++) {
                ...
                nw[list.indexOf(documents[m][n])][topic]++;
    ...
    private int sampleFullConditional(int m, int n) {
        ...
        for (int k = 0; k < K; k++) {
            p[k] = (nw[list.indexOf(documents[m][n])][k] + beta) / (nwsum[k] + V * beta)
    ...
    public static void main(String[] args) {
        ...
        // words in documents
        String[][] documents = { {"broccoli","bananas"},
            {"banana","spinach", "smoothie","breakfast"},
            {"Chinchillas","kittens"},
            {"sister","kitten",},
            {"hamster","broccoli"}};
    ...
    public static String shadeDouble(double d, double max) {
        int a = (int) Math.floor(d * 20 / max + 0.5);
        if (a > 10 || a < 0) {
