...
public class SentiWordNet {
	...
	private String location = "resources/word_lists/SentiWordNet.txt";
	...
	public SentiWordNet() {
		...
		try {
			BufferedReader csv = new BufferedReader(new FileReader(SentiWordNet.class.getClassLoader().getResource(location).getPath()));
			String line = "";
