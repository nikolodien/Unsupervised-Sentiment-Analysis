 ...
 */
public class CopyOfFindAccuracy {
        ...
        try {
            ...
            while ((read = br.readLine()) != null) {
                ...
                try {
                	...
                	String sentiment = fp.findOpinionDis(tok[0]);
                	if(sentiment.equals("pos") && pol.contains("pos"))Pos++;
                	else if(sentiment.equals("neg") && pol.contains("neg"))Neg++;
                	else if(sentiment.equals("obj") && pol.contains("obj"))Obj++;
                    if (pol.contains("pos")) {
                        PosT++;
